...
(defconst kaolin-faces
  `(
    ...
    ;(notmuch-search-count                nil)
    ;(notmuch-search-date                 nil)
    (notmuch-search-flagged-face         (:foreground hl))
    ;(notmuch-search-matching-authors     nil)
