...
(defconst kaolin-faces
  `(
    ...
    ;; Jabber
    (jabber-activity-face          (:foreground red1   :weight 'bold))
    (jabber-activity-personal-face (:foreground blue1  :weight 'bold))
    (jabber-chat-error             (:foreground error   :weight 'bold))
    (jabber-chat-prompt-foreign    (:foreground red1   :weight 'bold))
    (jabber-chat-prompt-local      (:foreground blue1  :weight 'bold))
    (jabber-chat-prompt-system     (:foreground green1 :weight 'bold))
    (jabber-chat-text-foreign      (:foreground fg1))
    (jabber-chat-text-local        (:foreground fg1))
    (jabber-rare-time-face         (:foreground green1))
    (jabber-roster-user-away       (:foreground yellow1))
    (jabber-roster-user-chatty     (:foreground green1 :weight 'bold))
    (jabber-roster-user-dnd        (:foreground red1))
    (jabber-roster-user-error      (:foreground error))
    (jabber-roster-user-offline    (:foreground fg3))
    (jabber-roster-user-online     (:foreground green1 :weight 'bold))
    (jabber-roster-user-xa         (:foreground cyan1))
