...
(let ((class '((class color) (min-colors 89)))
  ...
  (let* ((fg1  white)
    ...
    (custom-theme-set-faces
     ...
     `(telephone-line-evil-normal ((t (:foreground ,bg2 :background ,evil-normal :inherit telephone-line-evil))))
     `(telephone-line-evil-insert ((t (:foreground ,bg2 :background ,evil-insert :inherit telephone-line-evil))))
     `(telephone-line-evil-visual ((t (:foreground ,bg2 :background ,evil-visual :inherit telephone-line-evil))))
     `(telephone-line-evil-replace ((t (:foreground ,bg2 :background ,evil-replace :inherit telephone-line-evil))))
     `(telephone-line-evil-motion ((t (:foreground ,bg2 :background ,evil-motion :inherit telephone-line-evil))))
     `(telephone-line-evil-operator ((t (:foreground ,bg2 :background ,evil-operator :inherit telephone-line-evil))))
     `(telephone-line-evil-emacs ((t (:foreground ,bg2 :background ,evil-emacs :inherit telephone-line-evil))))
